node {
    ...
    stage('Deploy Docker Image and login'){
      ...
      echo "Docker Image Tag Name: ${dockerImageTag}"
        ...
        sh "docker images"
        sh "docker login -u ramiztakildar -p Ramiz@123" // put PWD
	...
	//sh "read imageid"
	   sh "docker tag fe576647eada  ramiztakildar/myapplication" //must change your name and tag no
        sh "docker push ramiztakildar/myapplication"
  }
}
